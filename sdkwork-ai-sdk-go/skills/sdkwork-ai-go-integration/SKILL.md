---
name: sdkwork-ai-go-integration
description: Use when integrating the sdkwork-ai-sdk-go package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-ai-sdk-go` into an application using progressive stages. Advance only when the current stage exits green.
...
- Registry integration: `go get github.com/sdkwork/ai-sdk@v1.0.0`
- Local-path integration: `go mod edit -replace github.com/sdkwork/ai-sdk=<path-to-sdkwork-ai-sdk-go> && go mod tidy`
