...
type Threads2Api struct {
    client *sdkhttp.Client
}

func NewThreads2Api(client *sdkhttp.Client) *Threads2Api {
    return &Threads2Api{client: client}
}

// Submit tool outputs
func (a *Threads2Api) SubmitToolOutputs(thread_id string, run_id string, body sdktypes.SubmitToolOutputsPostRequest) (sdktypes.SubmitToolOutputsPostResponse, error) {
...
// Cancel run
func (a *Threads2Api) CancelRun(thread_id string, run_id string) (sdktypes.RunResponse, error) {
...
// Get run
func (a *Threads2Api) GetRun(thread_id string, run_id string) (sdktypes.RunResponse, error) {
...
// Modify run
func (a *Threads2Api) UpdateRun(thread_id string, run_id string, body sdktypes.UpdateRunRequest) (sdktypes.RunResponse, error) {
...
// List runs
func (a *Threads2Api) ListRuns(thread_id string, query map[string]interface{}) (sdktypes.RunListResponse, error) {
...
// Create run
func (a *Threads2Api) CreateRun(thread_id string, body sdktypes.RunCreateRequest) (sdktypes.CreateRunPostResponse, error) {
...
// Get thread message
func (a *Threads2Api) GetThreadMessage(thread_id string, message_id string) (sdktypes.ThreadMessageResponse, error) {
...
func (a *Threads2Api) UpdateThreadMessage(thread_id string, message_id string, body sdktypes.ThreadMessageModifyRequest) (sdktypes.ThreadMessageResponse, error) {
...
func (a *Threads2Api) ListThreadMessages(thread_id string, query map[string]interface{}) (sdktypes.ThreadMessageListResponse, error) {
...
func (a *Threads2Api) CreateThreadMessage(thread_id string, body sdktypes.ThreadMessageCreateRequest) (sdktypes.ThreadMessageResponse, error) {
...
// Get thread
func (a *Threads2Api) GetThread(thread_id string) (sdktypes.ThreadResponse, error) {
...
// Update thread
func (a *Threads2Api) UpdateThread(thread_id string, body sdktypes.ThreadCreateRequest) (sdktypes.ThreadResponse, error) {
...
// Delete thread
func (a *Threads2Api) DeleteThread(thread_id string) (sdktypes.ThreadDeleteResponse, error) {
...
func (a *Threads2Api) CreateThreadAndRun(body sdktypes.ThreadRunCreateRequest) (sdktypes.CreateThreadAndRunResponse, error) {
...
// Create thread
func (a *Threads2Api) CreateThread(body sdktypes.ThreadCreateRequest) (sdktypes.ThreadResponse, error) {
...
// Get run step
func (a *Threads2Api) GetRunStep(thread_id string, run_id string, step_id string) (sdktypes.RunStepResponse, error) {
...
// List run steps
func (a *Threads2Api) ListRunSteps(thread_id string, run_id string, query map[string]interface{}) (sdktypes.RunStepListResponse, error) {
