---
name: sdkwork-ai-flutter-integration
description: Use when integrating the sdkwork-ai-sdk-flutter package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-ai-sdk-flutter` into an application using progressive stages. Advance only when the current stage exits green.
...
- SDK coordinate: `ai_sdk@1.0.0`
- Registry integration: `flutter pub add ai_sdk`
- Local-path integration: `flutter pub add ai_sdk --path <path-to-sdkwork-ai-sdk-flutter>`
