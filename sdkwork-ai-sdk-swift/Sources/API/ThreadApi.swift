...
public class ThreadApi {
    ...
    /// Submit tool outputs
    public func submitToolOutputs(thread_id: String, run_id: String, body: SubmitToolOutputsPostRequest) async throws -> SubmitToolOutputsPostResponse? {
        let response = try await client.post(ApiPaths.aiPath("/threads/\(thread_id)/runs/\(run_id)/submit_tool_outputs"), body: body)
        return response as? SubmitToolOutputsPostResponse
    }
    ...
    /// Create run
    public func createRun(thread_id: String, body: RunCreateRequest) async throws -> CreateRunPostResponse? {
        let response = try await client.post(ApiPaths.aiPath("/threads/\(thread_id)/runs"), body: body)
        return response as? CreateRunPostResponse
    }
    ...
    /// Create thread
    public func createThread(body: ThreadCreateRequest? = nil) async throws -> ThreadResponse? {
