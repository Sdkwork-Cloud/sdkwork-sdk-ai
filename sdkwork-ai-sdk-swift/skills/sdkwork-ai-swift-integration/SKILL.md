---
name: sdkwork-ai-swift-integration
description: Use when integrating the sdkwork-ai-sdk-swift package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-ai-sdk-swift` into an application using progressive stages. Advance only when the current stage exits green.
...
- SDK coordinate: `AiSDK | https://github.com/sdkwork/ai-sdk-swift | from 1.0.0`
- Registry integration: `.package(url: "https://github.com/sdkwork/ai-sdk-swift", from: "1.0.0")`
- Local-path integration: `.package(path: "<path-to-sdkwork-ai-sdk-swift>")`
