...
public class Chat2Api {
    ...
    public Chat2Api(HttpClient client) {
        this.client = client;
    }
    ...
    public ChatCompletionResponse updateCompletion(String completion_id, UpdateCompletionPostRequest body) throws Exception {
