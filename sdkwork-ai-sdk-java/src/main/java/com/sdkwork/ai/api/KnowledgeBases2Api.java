...
public class KnowledgeBases2Api {
    ...
    /** List documents */
    public ListDocumentsGetResponse listDocuments(String knowledgeBaseId, Map<String, Object> params) throws Exception {
        return (ListDocumentsGetResponse) client.get(ApiPaths.aiPath("/knowledge-bases/" + knowledgeBaseId + "/documents"), params);
    }
