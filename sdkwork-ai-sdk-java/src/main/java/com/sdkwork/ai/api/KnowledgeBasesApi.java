...
public class KnowledgeBasesApi {
    ...
    public ListDocumentsResponse listDocuments(String knowledgeBaseId, Map<String, Object> params) throws Exception {
        return (ListDocumentsResponse) client.get(ApiPaths.aiPath("/v1/knowledge-bases/" + knowledgeBaseId + "/documents"), params);
    }

    /** Add document */
    public DocumentResponse addDocument(String knowledgeBaseId, DocumentAddRequest body) throws Exception {
        return (DocumentResponse) client.post(ApiPaths.aiPath("/v1/knowledge-bases/" + knowledgeBaseId + "/documents"), body);
    }

    /** Search knowledge */
    public KnowledgeSearchResponse searchKnowledge(KnowledgeSearchRequest body) throws Exception {
        return (KnowledgeSearchResponse) client.post(ApiPaths.aiPath("/v1/knowledge-bases/search"), body);
    }

    /** List knowledge bases */
    public KnowledgeBaseListResponse listKnowledgeBases(Map<String, Object> params) throws Exception {
        return (KnowledgeBaseListResponse) client.get(ApiPaths.aiPath("/v1/knowledge-bases"), params);
    }

    /** Create knowledge base */
    public KnowledgeBaseResponse createKnowledgeBase(KnowledgeBaseCreateRequest body) throws Exception {
        return (KnowledgeBaseResponse) client.post(ApiPaths.aiPath("/v1/knowledge-bases"), body);
    }

    /** Get document */
    public DocumentResponse getDocument(String knowledgeBaseId, String documentId) throws Exception {
        return (DocumentResponse) client.get(ApiPaths.aiPath("/v1/knowledge-bases/" + knowledgeBaseId + "/documents/" + documentId + ""));
    }
    ...
    public KnowledgeBaseResponse getKnowledgeBase(String knowledgeBaseId) throws Exception {
        return (KnowledgeBaseResponse) client.get(ApiPaths.aiPath("/v1/knowledge-bases/" + knowledgeBaseId + ""));
    }
