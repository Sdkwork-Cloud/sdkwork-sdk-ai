...
public class ChatApi {
    ...
    public ChatCompletionResponse updateCompletion(String completion_id, UpdateCompletionRequest body) throws Exception {
    ...
    /** Update chat completion */
    public ChatCompletionResponse patchUpdateCompletion(String completion_id, PatchUpdateCompletionRequest body) throws Exception {
    ...
    public CountClaudeTokensResponse countClaudeTokens(CountClaudeTokensRequest body) throws Exception {
        return (CountClaudeTokensResponse) client.post(ApiPaths.aiPath("/messages/count_tokens"), body);
    }

    /** Create Claude message */
    public CreateClaudeMessageResponse createClaudeMessage(CreateClaudeMessageRequest body, Map<String, String> headers) throws Exception {
