...
public class ThreadsApi {
    ...
    public SubmitToolOutputsResponse submitToolOutputs(String thread_id, String run_id, SubmitToolOutputsRequest body) throws Exception {
        return (SubmitToolOutputsResponse) client.post(ApiPaths.aiPath("/threads/" + thread_id + "/runs/" + run_id + "/submit_tool_outputs"), body);
    }
    ...
    public CreateRunResponse createRun(String thread_id, RunCreateRequest body) throws Exception {
        return (CreateRunResponse) client.post(ApiPaths.aiPath("/threads/" + thread_id + "/runs"), body);
    }
