---
name: sdkwork-ai-python-integration
description: Use when integrating the sdkwork-ai-sdk-python package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-ai-sdk-python` into an application using progressive stages. Advance only when the current stage exits green.
...
- Local-path integration: `pip install <path-to-sdkwork-ai-sdk-python>`
...
- `python -m pip show sdkwork-ai-sdk`
