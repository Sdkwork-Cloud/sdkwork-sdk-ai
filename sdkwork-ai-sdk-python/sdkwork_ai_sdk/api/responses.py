...
from ..models import CancelResponseResponse, CreateResponseRequest, CreateResponseResponse, DeleteResponseResponse, GetResponseResponse, ListResponseInputItemsResponse
...
class ResponsesApi:
    ...
    def cancel_response(self, response_id: str) -> CancelResponseResponse:
        """Cancel response"""
