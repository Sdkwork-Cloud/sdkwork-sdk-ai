...
class KnowledgeBases2Api:
    """knowledge_bases API client."""
    
    def __init__(self, client: HttpClient):
        self._client = client

    def list_documents(self, knowledgeBaseId: str, params: Optional[Dict[str, Any]] = None) -> ListDocumentsGetResponse:
        """List documents"""
        return self._client.get(f"/ai/v3/knowledge-bases/{knowledgeBaseId}/documents", params=params)

    def add_document(self, knowledgeBaseId: str, body: DocumentAddRequest) -> DocumentResponse:
        """Add document"""
        return self._client.post(f"/ai/v3/knowledge-bases/{knowledgeBaseId}/documents", json=body)
    ...
    def get_document(self, knowledgeBaseId: str, documentId: str) -> DocumentResponse:
        """Get document"""
        return self._client.get(f"/ai/v3/knowledge-bases/{knowledgeBaseId}/documents/{documentId}")

    def delete_document(self, knowledgeBaseId: str, documentId: str) -> None:
        """Delete document"""
        return self._client.delete(f"/ai/v3/knowledge-bases/{knowledgeBaseId}/documents/{documentId}")

    def get_knowledge_base(self, knowledgeBaseId: str) -> KnowledgeBaseResponse:
        """Get knowledge base"""
        return self._client.get(f"/ai/v3/knowledge-bases/{knowledgeBaseId}")

    def delete_knowledge_base(self, knowledgeBaseId: str) -> None:
        """Delete knowledge base"""
        return self._client.delete(f"/ai/v3/knowledge-bases/{knowledgeBaseId}")
