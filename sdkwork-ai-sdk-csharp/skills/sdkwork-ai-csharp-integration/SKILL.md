---
name: sdkwork-ai-csharp-integration
description: Use when integrating the sdkwork-ai-sdk-csharp package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-ai-sdk-csharp` into an application using progressive stages. Advance only when the current stage exits green.
...
- Language: `csharp`
- Build descriptor: `Ai.csproj`
- SDK coordinate: `Ai@1.0.0`
- Registry integration: `dotnet add package Ai --version 1.0.0`
- Local-path integration: `dotnet add <target.csproj> reference <path-to-sdkwork-ai-sdk-csharp/Ai.csproj>`
