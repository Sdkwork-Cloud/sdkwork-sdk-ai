...
namespace Ai.Api
{
    public class KnowledgeBases2Api
    {
        ...
        public KnowledgeBases2Api(HttpClient client)
        {
            _client = client;
        }
        ...
        /// List documents
        /// </summary>
        public async Task<ListDocumentsGetResponse?> ListDocumentsAsync(string knowledgeBaseId, Dictionary<string, object>? query = null)
        {
            return await _client.GetAsync<ListDocumentsGetResponse>(ApiPaths.AiPath($"/knowledge-bases/{knowledgeBaseId}/documents"), query);
        }
