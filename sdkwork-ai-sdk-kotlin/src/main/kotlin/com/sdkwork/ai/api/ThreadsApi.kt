...
class ThreadsApi(private val client: HttpClient) {
    ...
    suspend fun submitToolOutputs(thread_id: String, run_id: String, body: SubmitToolOutputsRequest): SubmitToolOutputsResponse? {
        return client.post(ApiPaths.aiPath("/threads/$thread_id/runs/$run_id/submit_tool_outputs"), body) as? SubmitToolOutputsResponse
    }
    ...
    suspend fun createRun(thread_id: String, body: RunCreateRequest): CreateRunResponse? {
        return client.post(ApiPaths.aiPath("/threads/$thread_id/runs"), body) as? CreateRunResponse
    }
